            ...
            <div className="flex flex-col md:flex-row items-center gap-6 p-8">
              <div className="flex-shrink-0">
                <div className="w-32 h-32 rounded-2xl overflow-hidden ring-4 ring-[#F2C94C]/20">
                  <ImageWithFallback
                    src="https://images.unsplash.com/photo-1628682814461-c4461c974211?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcm9mZXNzaW9uYWwlMjBBZnJpY2FuJTIwQ0VPJTIwcG9ydHJhaXR8ZW58MXx8fHwxNzYzNzIyMzM5fDA&ixlib=rb-4.1.0&q=80&w=1080"
                    alt="Gaga Andy - CEO"
